                    ...
                    <tbody>
                        ...
                        <tr>
                            <td style="padding-top: 6px;">
                                ...
                                ?>
                                <input type="checkbox" <?= $permanent == true ? "checked" : "" ?> name="filter[permanent]" id="permanent" value="1"><label for="permanent">Permanent</label>
                                <input type="checkbox" <?= $contract == true ? "checked" : "" ?> name="filter[contract]" value="1" id="contract"><label for="permanent">Contract</label>
                                <input type="checkbox" <?= $temporary == true ? "checked" : "" ?> name="filter[temporary]" id="temporary" value="1"> <label for="permanent">Temporary</label>
                                <input type="checkbox" <?= $self_employed == true ? "checked" : "" ?> style="margin-left: 3px;" name="filter[self_employed]" id="self_employed" value="1"><label for="self_employed">Self Employed</label>
                            </td>
                        </tr>
            ...
            if (!empty($jobs_vac)) {
                ...
                <?php foreach ($jobs_vac as $job) { ?>
                    <div class="job">
                        ...
                        <?php if ($feed_type == '1') { ?>
                            <p><span class="type"><label><b>Type:</b></label><?= esc_html(($job['JobType'])) ?></span></p>
                        <?php } ?>
                        ...
                        <?php if ($feed_summary == '1' && $job['Description'] != '') { ?>
                            ...
                            <p><span class="summary"><label><b>Summary:</b></label>
                                    <div class="desc-wrapper"><?= (($job['Description']) ? substr(nl2br($job['Description']), 0, $summary_characters) . ((strlen($job['Description']) > $summary_characters) ? '.....' : '..') : '..') ?></div>
                                </span></p>
                        <?php } ?>
